...
app.layout = dbc.Container([
    ...
    year_slider,
    month_slider,
    dcc.RadioItems(options=['Summary Page - Facts', 'Summary Page for Section Heads', 'General Summary','Library Instruction Service'], value='Summary', id='controls-and-radio-item'),
