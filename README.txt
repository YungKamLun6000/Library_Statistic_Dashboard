...
Start the WebAPI by run the main.py
...
2. **layout**: Defines the front-end components (such as input fields, graphs, and tables) displayed in your browser.
3. **@callback**: Allows interaction between components (e.g., responding to user input).
